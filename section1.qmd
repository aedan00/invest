...
An example was the outage involving CrowdStrike (CRWD).  
After the report of the global outage in July, 2024, CRWD plunged 30% within three trading days
...
<style>
  body {
    ...
    background-image: url('invest-background-tickers.png');
